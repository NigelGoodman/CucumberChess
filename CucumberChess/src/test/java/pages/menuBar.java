...
public class menuBar 
{
	...
	private static By toolsMenuButton = By.cssSelector("#topnav > section:nth-child(6) > a:nth-child(1)");
	private static By analysisBoardButton = By.linkText("Analysis board");
	private static By importGameButton = By.cssSelector("#topnav > section:nth-child(6) > div:nth-child(2) > a:nth-child(4)");//By.linkText("Import game");
